 ...
 * @author jacob
 */
public class WindowStudentModule extends javax.swing.JFrame {
...
ArrayList<Module> modules;
     ...
     * @param mainMenu
     */
    public WindowStudentModule(Menu mainMenu) {
        initComponents();
      ...
      jList2.setModel((ListModel)modelStudent);
    }
    ...
    System.out.println("module seleced: " + jList1.getSelectedValue());
    System.out.println("student selected: " + jList2.getSelectedValue());
    if( jList1.getSelectedIndex() >= 0 && jList2.getSelectedIndex() >=0)
    {
    mainMenu.connectStudentModule(
        students.get(jList2.getSelectedIndex()).getStudentNo(),
        modules.get(jList1.getSelectedIndex()).getModuleCode());
    }
